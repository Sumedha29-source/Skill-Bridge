    ...
    >
      ...
      <nav className="signup-nav">
        ...
        >
          ...
          <span>
            Skill<span className="signup-brand-text">Bridge</span>
          </span>
        </button>
      ...
      <main className="signup-main">
        <section className="signup-card">
          <p className="signup-eyebrow">// Join the network</p>

          <h1>
            Create your <span>SkillBridge</span> account
          </h1>
          ...
          <div className="signup-perks">
            <div className="signup-perk">
              ...
              Verified student &amp; college profiles
            </div>
            ...
            <div className="signup-perk">
              ...
              Smart skill-based opportunity matching
            </div>
          </div>

          <div className="signup-role-section">
            <div className="signup-role-label">I am joining as</div>
            ...
            <div className="signup-role-grid">
              ...
              >
                ...
                <span className="signup-role-name">Student</span>
              </button>
              ...
              >
                <span className="signup-role-icon">🏛️</span>
                <span className="signup-role-name">College</span>
              </button>
          ...
          <form onSubmit={handleSignup}>
            ...
            {message && (
              <div className="signup-alert success">{message}</div>
            )}
